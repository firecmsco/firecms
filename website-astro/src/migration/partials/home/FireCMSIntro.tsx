...
// Removed Docusaurus alias-based SVG imports; using public /img paths instead
        ...
        <Panel color={"transparent"}
            ...
            <div className={clsx("relative flex justify-center mb-8 border-b border-0", defaultBorderMixin)}>
                <div
                    ...
                    <img src="/img/firebase.svg" alt="Firebase" style={{
                        width: 130,
                        height: 150,
                        maxWidth: "30%"
                    }} />
                    <img src="/img/reactjs-icon.svg" alt="React" style={{
                        width: 150,
                        height: 150,
                        maxWidth: "35%"
                    }} />
                    <img src="/img/tailwind_logo.svg" alt="Tailwind CSS" style={{
                        width: 140,
                        height: 150,
                        maxWidth: "30%"
                    }} />
                    <img src="/img/typescript_logo.svg" alt="TypeScript" style={{
                        width: 130,
                        height: 130,
                        maxWidth: "30%"
                    }} />
