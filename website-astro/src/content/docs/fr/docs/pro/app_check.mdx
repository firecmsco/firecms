---
title: "Firebase App Check (auto-hébergé)"
slug: fr/docs/pro/app_check
description: "Activez Firebase App Check dans une app FireCMS auto-hébergée via la prop appCheck et un fournisseur reCAPTCHA."
---
FireCMS auto-hébergé peut imposer Firebase App Check sur chaque requête que votre panneau d'administration envoie à Firestore et Storage, afin que seul votre propre CMS puisse lire ou écrire vos données, et non une clé d'API copiée ou un script extrait de votre bundle.
