---
slug: it/"docs/api/interfaces/BooleanProperty"
...
[@firecms/core](../README) / BooleanProperty

# Interface: BooleanProperty

Defined in: [types/properties.ts:341](https://github.com/firecmsco/firecms/blob/main/packages/firecms_core/src/types/properties.ts)

## Extends

- [`BaseProperty`](BaseProperty)\<`boolean`\>
...
Defined in: [types/properties.ts:343](https://github.com/firecmsco/firecms/blob/main/packages/firecms_core/src/types/properties.ts)
...
> `optional` **defaultValue**: `boolean` \| `null`
...
> `optional` **Field**: `ComponentType`\<[`FieldProps`](FieldProps)\<`boolean`, `any`, `any`\>\>
...
> `optional` **Preview**: `ComponentType`\<[`PropertyPreviewProps`](PropertyPreviewProps)\<`boolean`, `any`\>\>
...
Defined in: [types/properties.ts:348](https://github.com/firecmsco/firecms/blob/main/packages/firecms_core/src/types/properties.ts)
