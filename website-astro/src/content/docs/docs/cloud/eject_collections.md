...
Consider the Books collection from our [demo](https://demo.rebase.pro). The collection includes fields such as Title,
...
But what if you need to **customize** the view **further**, or prefer to use code to create the collection? Rebase
allows you to do just that. You can start a customization process with
our [quickstart guide](https://rebase.pro/docs/cloud/quickstart) and then upload it to the Cloud, using the same
hosted app.
...
In summary, the latest version of [Rebase](https://app.rebase.pro) provides a **seamless No Code experience** for
managing your CMS. However, if you need to customize your CMS further, you can easily switch to a Code-based approach.
All within a single app, [app.rebase.pro](https://www.notion.so/e8af421701bb440ebcc4ef4ce265e9ad?pvs=21).
