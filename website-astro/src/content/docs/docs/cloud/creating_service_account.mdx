...
description: Connect your existing **GCP project** to Rebase Cloud using a service account for secure **data management**.
---
...
One possible way to create a Rebase Cloud project and link it to your **existing** GCP project is by creating
