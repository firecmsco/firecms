...
description: Connect your existing **Firebase project** to Rebase Cloud using a service account for secure **data management**.
---

:::important
You **only** need to create a service account manually for Rebase Cloud projects, in case you don't want
to grant Rebase admin permissions. In the app, you can create a new project or link existing projects
without the need to create a service account manually.
:::

One possible way to create a Rebase Cloud project and link it to your **existing** Firebase/GCP project is by creating
...
- Select the project you want to link to Rebase.
...
- Fill in the details for the service account. Name it `Rebase`.
...
- Now let's create the JSON key that will be uploaded to Rebase Cloud.
...
Now you can **upload this JSON key** to **Rebase Cloud** and link it to your project.
...
access your GCP resources. Rebase Cloud uses this service account to manage your project resources.
