...
title: "App Check: Securing your Admin Panel"
description: "Secure your Firebase admin panel and internal tools using Firebase App Check. Protect your CMS from abuse and unauthorized access."
---
...
Rebase provides a simple way to integrate Firebase App Check with your app.

:::important
Remember to add the domain `app.rebase.pro` to the list of allowed domains in AppCheck provider configuration.
:::

You can enable Firebase App Check in your app directly in the **project settings** in the Rebase Cloud console,
...
:::important
Make sure you have added the domain `app.rebase.pro` to the list of allowed domains in the reCAPTCHA Enterprise console.
:::
...
Rebase Cloud can share dependencies with your uploaded app. It is important than your app and Rebase Cloud use the same version of Firebase App Check.
In order to do so, make sure, in your `vite.config.ts`, you are using the shared dependency provided by Rebase.
