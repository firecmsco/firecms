...
description: Add role-based access control to your Firebase admin panel with the Rebase User Management plugin. Manage users, roles, and permissions in Firestore.
---

![user_management.png](/img/user_management.png)

Control who can access your **Firebase admin panel** and what they can do. The User Management Plugin provides a complete **role-based access control (RBAC)** system for your Rebase project.
...
To use the plugin, you need to have Rebase and Firebase set up in your project.
...
The default config of the plugin will be saved to your database under the path `__REBASE/config`,
...
- **usersPath**: Path in Firestore where user configurations are stored. Default is `__REBASE/config/users`.
- **rolesPath**: Path in Firestore where role configurations are stored. Default is `__REBASE/config/roles`.
...
const userManagement = useBuildUserManagement({
    ...
    usersPath: "__REBASE/config/users",
    rolesPath: "__REBASE/config/roles",
