...
FireCMS PRO costs **€99 / month for the first project** and **€49 / month for each additional project** on the same license.
...
Nothing is ever blocked because a license has more projects linked than it pays for. The app shows a notice asking you to update the license.
