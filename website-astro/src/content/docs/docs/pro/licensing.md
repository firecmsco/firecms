...
title: Licensing
description: Rebase PRO licensing information, including how to purchase and configure your license for deployment.
---

:::tip
Do you have any questions, would like to request a trial, or need a custom license?
Please [contact us via email](mailto:hello@rebase.pro),
...
You can use the Rebase PRO features locally during development without a license, but you will need to
