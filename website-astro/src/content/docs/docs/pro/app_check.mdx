...
title: App Check
description: Integrate Firebase App Check with Rebase to protect your backend from abuse using reCAPTCHA providers.
---
...
```tsx
import {useAppCheck} from "@rebasepro/firebase";
