...
The default config of the plugin will be saved to your database in the `_rebase_users` and `_rebase_roles` tables,
...
- **usersPath**: Path/table where user configurations are stored. Default is `_rebase_users`.
- **rolesPath**: Path/table where role configurations are stored. Default is `_rebase_roles`.
...
const userManagement = useBuildUserManagement({
    dataSource,
    usersPath: "_rebase_users",
    rolesPath: "_rebase_roles",
