...
description: Learn how to use entity callbacks in Rebase to add metadata to your entities such as metadata or implement custom logic rules.
---
...
In Rebase we have been using these features in all versions, and it's also available in version 3.0.
...
Full code available in the [Rebase repository](https://github.com/marianmoldovan/rebase-entity-callbacks-cars)
