...
description: A comprehensive guide to securing your self-hosted FireCMS deployment when using a custom backend with your own database, custom authentication, and custom file storage.
---
