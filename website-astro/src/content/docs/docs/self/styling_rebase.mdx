...
You may want to check the original [`tailwind.config.js`](https://github.com/rebaseco/rebase/blob/main/packages/ui/tailwind.config.js)
...
[`index.css`](https://github.com/rebaseco/rebase/blob/main/packages/ui/src/index.css) file in the `@rebasepro/ui` package.
