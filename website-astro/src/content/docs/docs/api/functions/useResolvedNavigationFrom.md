...
Defined in: [core/src/hooks/useResolvedNavigationFrom.tsx:125](https://github.com/rebasepro/rebase/blob/main/packages/core/src/hooks/useResolvedNavigationFrom.tsx)
