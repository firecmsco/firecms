...
Defined in: [core/src/hooks/useResolvedNavigationFrom.tsx:125](https://github.com/rebaseco/rebase/blob/main/packages/core/src/hooks/useResolvedNavigationFrom.tsx)
