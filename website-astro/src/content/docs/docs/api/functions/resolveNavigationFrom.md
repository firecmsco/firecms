...
Defined in: [core/src/hooks/useResolvedNavigationFrom.tsx:58](https://github.com/rebasepro/rebase/blob/main/packages/core/src/hooks/useResolvedNavigationFrom.tsx)
