---
slug: "docs/api/functions/useSideEntityController"
...
[@rebasepro/core](../README) / useSideEntityController

# Function: useSideEntityController()

> **useSideEntityController**(): [`SideEntityController`](../interfaces/SideEntityController)

Defined in: [hooks/useSideEntityController.tsx:15](https://github.com/rebaseco/rebase/blob/main/packages/core/src/hooks/useSideEntityController.tsx)
