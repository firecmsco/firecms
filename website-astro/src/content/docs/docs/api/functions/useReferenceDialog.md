...
[@rebasepro/core](../README) / useReferenceDialog

# Function: useReferenceDialog()

> **useReferenceDialog**\<`M`\>(`referenceDialogProps`): `object`

Defined in: [hooks/useReferenceDialog.tsx:16](https://github.com/rebaseco/rebase/blob/main/packages/core/src/hooks/useReferenceDialog.tsx)
