...
Build your own **Firebase admin panel** and **headless CMS** with full control over your infrastructure. Rebase self-hosted versions let you deploy a powerful **React-based back-office** on your own servers, with complete data ownership.
...
This will create a new Rebase, Community or PRO, project in the selected folder.
A Rebase project is a React application that you can customize to fit your needs.
