---
slug: de/"docs/api/interfaces/GeopointProperty"
title: "GeopointProperty"
---
...
[@firecms/core](../README) / GeopointProperty

# Interface: GeopointProperty

Defined in: [types/properties.ts:625](https://github.com/firecmsco/firecms/blob/main/packages/firecms_core/src/types/properties.ts)

## Extends

- [`BaseProperty`](BaseProperty)\<[`GeoPoint`](../classes/GeoPoint)\>
...
Defined in: [types/properties.ts:627](https://github.com/firecmsco/firecms/blob/main/packages/firecms_core/src/types/properties.ts)
...
> `optional` **defaultValue**: [`GeoPoint`](../classes/GeoPoint) \| `null`
...
> `optional` **Field**: `ComponentType`\<[`FieldProps`](FieldProps)\<[`GeoPoint`](../classes/GeoPoint), `any`, `any`\>\>
...
> `optional` **Preview**: `ComponentType`\<[`PropertyPreviewProps`](PropertyPreviewProps)\<[`GeoPoint`](../classes/GeoPoint), `any`\>\>
...
Defined in: [types/properties.ts:632](https://github.com/firecmsco/firecms/blob/main/packages/firecms_core/src/types/properties.ts)
