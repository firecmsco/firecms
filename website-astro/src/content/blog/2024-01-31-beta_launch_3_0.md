...
title: Beta Launch, Rebase 3.0 Cloud and Cloud Plus
description: Announcing Rebase 3.0 - The next generation CMS is here with Cloud and Cloud Plus offerings.
pubDate: 2024-01-31
authors: marian
image: /img/blog/demo_books_llm.webm
---


## Rebase 3.0 The Next CMS that is already here.🔥

Three years ago we launched the first version of Rebase. We started offering an open source core so that anyone could
build whatever they need. Rebase started as an internal tool that we offered to our clients. The usual use case is: you
...
of the project and use it to develop internal apps for their own clients. Since it’s inception, Rebase has been
downloaded 200k+ times in NPM.

Along the years we understood that we need to make it simple for the customer to install and configure Rebase, but also
...
## Launching the Beta version of Rebase 3
...
One of the most significant additions to Rebase 3.0 is the introduction of the SaaS cloud-hosted version. This new
offering allows users to easily access and manage their Rebase projects directly from the cloud. With this feature,
users no longer need to worry about setting up and maintaining their own infrastructure, as Rebase takes care of it
...
Your data is yours, we don’t need to access it. Each Rebase project is linked to a Firebase project, that is owned by
...
With Rebase 3.0, customization options have been taken to the next level. Now, users can leverage the power of code to
personalize their CMS even further. Whether it's tweaking the layout, adding custom fields, or implementing complex
business logic, developers have the flexibility to extend and modify Rebase to suit their specific needs. This level of
customization empowers users to create truly unique and tailored CMS experiences. We even built
a [CLI](https://rebase.pro/docs/deployment##rebase-cli) for that. Start the project, write the code, upload it and find
the features in
the [app](https://www.notion.so/Beta-Launch-Rebase-3-0-Cloud-and-Cloud-Plus-c99f446121614ae5bb832e8123ef071c?pvs=21).
Extend the React basecode with Typescript or Javascript.

![An example of highly customized instance of Rebase, with the ThreeJS editor integrated](/img/blog/overlay-6cd67e9930912d6032204e3f9b253171.webp)
> An example of highly customized instance of Rebase, with the ThreeJS editor integrated

We have also built a [CLI](https://rebase.pro/docs/deployment##rebase-cli) for making the interaction with the Cloud
...
![Rebase collection editor](/img/blog/editor.png)

But it gets even better! Rebase can automatically detect new values and add them to the schema with just a single
...
### New data inference[](https://rebase.pro/docs/what_is_new_v3##new-data-inference)

Do you have a few collections in your project and want to get started quickly? Rebase can now **infer the schema from
your data**. This means that you can begin using Rebase in just a few minutes, without the need to write a single line
of code. Simply import a data file and start immediately.

### 💽 Data import and export[](https://rebase.pro/docs/what_is_new_v3##data-import-and-export)

Now, you can import and export the data. As we've stated, you are the owner of the data and it's up to you to decide.

#### Import[](https://rebase.pro/docs/what_is_new_v3##import)
...
![Import data view](/img/blog/import.png)
...
Versions 1.0 and 2.0 of Rebase were based on Material UI (mui). This was great for getting started quickly, but it had
...
In Rebase 3.0, we have migrated to Tailwind CSS. This is a utility-first CSS framework that allows us to generate a
...
In Rebase 3.0, components, icons and colors have received a significant upgrade.
...
We decided to provide a free tier of use of the CMS. **Rebase Cloud Free**. This is everything you have in the Free
version:
...
If you need some extra features, we have **Rebase Cloud Plus**, which includes:
...
Go to [app.rebase.pro](https://app.rebase.pro/) and create your project.

### What are you going to build?

We want to hear about it :) Find us
on [Discord](https://discord.gg/fxy7xsQm3m), [LinkedIn](https://www.linkedin.com/company/rebase/?originalSubdomain=es),
