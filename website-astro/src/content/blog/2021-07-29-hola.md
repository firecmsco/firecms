...
slug: hola
title: Hello! Hola!
description: Welcome to the Rebase blog! Learn about our journey building a generic headless CMS solution based on Firebase.
pubDate: 2021-07-29
authors: francesco
---

### Welcome to the **Rebase** blog!

We will use this blog to keep you up to date of the latest updates regarding
Rebase, as well as case-studies!
...
- Or they don't provide **enough features**. The best solution we have found is
  Firetable, which shares some core concepts of Rebase, but we find a bit limited
...
Rebase allows setting up a CMS in no time, just by introducing your collections
...
We hope you enjoy using Rebase as much as we do while developing it, and I
