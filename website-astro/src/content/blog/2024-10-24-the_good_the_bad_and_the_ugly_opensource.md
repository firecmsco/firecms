...
description: An honest look at the realities of open source development - the triumphs, challenges, and harsh truths.
pubDate: 2024-10-24
image: /img/blog/client_eastwood_the_good.jpeg
authors: marian
---

![The good the bad and the ugly](/img/blog/client_eastwood_the_good.jpeg)
...
our [initial commit](https://github.com/rebaseco/rebase/commit/6508f8d7db7e7ae29f493023550271be009b3b89) on GitHub in
April 2020.

Since its inception, [Rebase](https://github.com/rebaseco/rebase) has evolved from an internal tool to a widely-used
open-source content management system (CMS) that helps developers build and prototype products efficiently. We want to
share our experiences; the good, the bad, and the ugly of building Rebase in public with an open-source license.

## The Good

Our journey with Rebase began as an in-house solution to streamline our development process. Seeing it grow beyond our
...
Watching Rebase grow organically has been incredibly rewarding. We've always felt that we're doing something right as
the community and usage expand naturally. Seeing developers embrace our project fills us with pride and motivates us
immensely.

![Rebase Dashboard](/img/blog/rebase_demo.png)
*The intuitive interface of Rebase that our users love.*
...
Open source thrives on community contributions, and we hope more developers will join us in enhancing Rebase.

## What's next?

More Rebase, for sure. Struggles and everything, we are still obsessed in making functional and beautiful software. So
check the releases, get in our [Discord](https://discord.gg/fxy7xsQm3m), start a project
in [Rebase Cloud](https://app.rebase.pro/) or give us a star in [Github](https://github.com/rebaseco/rebase).
