...
export function GoogleCloudLogo({
    ...
    return (
        <svg
            ...
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 181 28">
            <defs>
                <style>{".cls-1{fill:#ea4335;}.cls-2{fill:#4285f4;}.cls-3{fill:#34a853;}.cls-4{fill:#fbbc05;}" + (mode === "light" ? ".cls-5{fill:#5f6368;}" : ".cls-5{fill:#a9adb3;}")}</style>
            </defs>
