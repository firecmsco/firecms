...
import { PageBuilderView } from "./page_builder";
...
export function App() {
    ...
    const views: CMSView[] = useMemo(() => ([
        {
            ...
            name: "Page Builder",
            group: "Custom views",
            description: "Visual landing page builder powered by Puck",
            view: <PageBuilderView />
        },
        {
            path: "additional",
            name: "Additional",
    ...
    const mediaManagerPlugin = useMediaManagerPlugin({
        storageSource,
        dataSourceDelegate: firestoreDelegate,
        storagePath: "media",
