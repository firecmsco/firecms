...
content = content.replace(/from "\.\.\/auth"/g, 'from "@rebasepro/server-core"');
content = content.replace(/from "\.\.\/email"/g, 'from "@rebasepro/server-core"');
content = content.replace(/from "\.\.\/history"/g, 'from "@rebasepro/server-core"');
content = content.replace(/from "\.\.\/init"/g, 'from "@rebasepro/server-core"');
content = content.replace(/from "\.\.\/api\/types"/g, 'from "@rebasepro/server-core"');
