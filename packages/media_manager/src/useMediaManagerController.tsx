...
export function useMediaManagerController({
    ...
    const refreshAssets = useCallback(async () => {
        ...
        try {
            ...
            const entities = await driver.fetchCollection<Record<string, any>>({
                path: collectionPath,
                orderBy: "createdAt",
                order: "desc"
            });
    ...
    }, [driver, collectionPath, fetchDownloadURL]);
    ...
    const uploadFile = useCallback(async (
        ...
        const entity = await driver.saveEntity<Record<string, any>>({
            path: collectionPath,
            values: assetData,
            status: "new"
        });
        ...
        return newAsset;
    }, [storageSource, driver, storagePath, collectionPath, bucket, thumbnailSizes, thumbnailPath]);
    ...
    }, [assets, storageSource, driver, collectionPath, selectedAsset]);
    ...
    }, [assets, driver, collectionPath, selectedAsset]);
