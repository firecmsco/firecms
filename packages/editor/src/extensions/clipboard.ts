...
export function serializeForClipboard(view: any, slice: Slice) {
    view.someProp("transformCopied", (f: any) => {
        slice = f(slice!, view)
    })
    ...
    const text = view.someProp("clipboardTextSerializer", (f: any) => f(slice, view)) ||
