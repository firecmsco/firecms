...
export const it: FireCMSTranslations = {
    ...
    license_over_quota_banner: "La licenza di questo progetto copre {{licensed}} progetti in produzione, e questo non è tra quelli. Le funzioni PRO, come l'editor degli schemi, l'importazione/esportazione e la cronologia, sono in pausa; i tuoi dati e le tue collezioni continuano a funzionare.",
    license_over_quota_banner_one: "La licenza di questo progetto copre {{licensed}} progetto in produzione, ed è un altro. Le funzioni PRO, come l'editor degli schemi, l'importazione/esportazione e la cronologia, sono in pausa; i tuoi dati e le tue collezioni continuano a funzionare.",
    ...
    export_error: "Impossibile esportare i dati: {{message}}",
    submit: "Invia",
