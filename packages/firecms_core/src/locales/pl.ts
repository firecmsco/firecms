...
export const pl: FireCMSTranslations = {
    ...
    license_over_quota_banner: "Liczba projektów w produkcji objętych licencją tego projektu: {{licensed}}. Ten projekt do nich nie należy. Funkcje PRO, takie jak edytor schematów, import/eksport i historia, są wstrzymane; Twoje dane i kolekcje nadal działają.",
    license_over_quota_banner_one: "Licencja tego projektu obejmuje {{licensed}} projekt w produkcji i jest to inny projekt. Funkcje PRO, takie jak edytor schematów, import/eksport i historia, są wstrzymane; Twoje dane i kolekcje nadal działają.",
    ...
    export_error: "Nie udało się wyeksportować danych: {{message}}",
    submit: "Wyślij",
