...
export const es: FireCMSTranslations = {
    ...
    unsaved_changes: "Tienes cambios sin guardar en este {{collectionName}}.",
    so_empty: "Tan vacío...",
    ...
    collection_does_not_exist: "La colección especificada no existe",
    ...
    should_documents_opened_full_screen: "¿Deben abrirse los documentos en pantalla completa o en un panel lateral?",
    ...
    property_not_editable_description: "Puede que no tengas permisos para editarla o está definida en código como no editable.",
    ...
    must_be_at_least_one_admin: "Debe haber al menos un administrador",
    ...
    must_specify_target_collection: "Debe especificar una colección de destino para el campo",
    need_specify_repeat_field: "Debe especificar un campo de repetición",
    need_specify_block_properties: "Debe especificar las propiedades de este bloque",
    incomplete_condition: "Condición incompleta - por favor seleccione un campo",
    ...
    kanban_property_not_found: "La propiedad \"{{property}}\" no existe o no es una propiedad de tipo string con enum. Seleccione una propiedad válida o borre la selección.",
    no_enum_string_properties: "No se encontraron propiedades de tipo string con enum. Agregue una propiedad string con enumValues para usar la vista Kanban.",
    kanban_column_description: "Seleccione una propiedad de tipo string con valores enum para agrupar entidades en columnas",
    create_property: "+ Crear propiedad \"{{property}}\"",
    order_property: "Propiedad de orden",
    order_property_not_found: "La propiedad \"{{property}}\" no existe o no es una propiedad numérica. Seleccione una propiedad válida o borre la selección.",
    no_number_properties: "No se encontraron propiedades numéricas. Agregue una propiedad numérica para habilitar el ordenamiento.",
    order_property_description: "Seleccione una propiedad numérica para mantener el orden de los elementos",
    ...
    side_dialog_width_description: "Opcionalmente defina el ancho (en píxeles) del diálogo lateral de entidades. El valor predeterminado es 768px",
