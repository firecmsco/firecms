...
export const en: FireCMSTranslations = {
    ...
    settings_subscription_plan: "Subscription Plan",
    settings_subscribed_to: "You are currently subscribed to",
    settings_no_active_subscription: "Currently there is no active subscription for this project.",
    settings_trial_valid_until: "Your trial is valid until {{date}}.",
    settings_features_intro: "These are some of the features you are already enjoying by using FireCMS Cloud",
    settings_feature_managed_service: "Managed always up-to-date service",
    settings_feature_local_text_search: "Local text search",
    settings_feature_unlimited_users_roles: "Unlimited users and roles",
    settings_feature_theme_logo: "Theme and logo customization",
    settings_feature_custom_fields_views: "Custom form fields and custom views",
    settings_feature_secondary_databases: "Secondary databases",
    settings_feature_ai_content: "AI content generation with OpenAI and Google",
    settings_feature_unlimited_export: "Unlimited data export",
    ...
    settings_create_subscription: "Create a subscription",
    settings_stripe_disclaimer: "You will be redirected to Stripe to complete your subscription. Billed monthly based on your maximum users this month. Cancel anytime - you've already paid for the current billing period, so no additional charges after cancellation.",
    settings_subscription_is: "The subscription is",
    settings_next_payment_on: "The next payment is on {{date}}.",
    settings_seats_count: "You have",
    settings_seat: "seat",
    settings_seats: "seats",
    settings_per_seat: "at {{price}}/seat/{{interval}}",
    settings_current_price: "The current price is",
    settings_per_user_usage: "per user (usage-based).",
    settings_cancelled_active_until: "This subscription was cancelled and will be active until {{date}}.",
    settings_no_additional_charges: "No additional charges will apply after cancellation.",
    ...
    settings_appcheck_description: "You can enable AppCheck to protect your Firebase services from abuse. Check how to configure it in the Firebase documentation. When you have a provider set, you can enable it here. You will need to provide a secret in your Firebase project settings, and a site key in the FireCMS config.",
    settings_appcheck_add_domain: "Remember to add the domain {{domain}} to your provider allowed domains",
    settings_appcheck_enable: "Enable AppCheck",
    settings_appcheck_site_key: "Site key",
    settings_appcheck_update: "Update AppCheck",
