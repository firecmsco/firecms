...
export const UIStyleGuide = () => {
    ...
    return (
        <Container className="py-10 max-w-5xl">
            <Typography variant="h2" gutterBottom>FireCMS UI Style Guide</Typography>
            <Typography variant="body1" color="secondary" className="mb-8">
                A showcase of all typography and button variants available in the @firecms/ui library.
            </Typography>
