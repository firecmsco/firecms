...
export function PropertyConfigBadge({
    ...
    const defaultPropertyConfig = typeof propertyConfig?.property === "object" ? getDefaultFieldConfig(propertyConfig.property as import("@firecms/types").Property) : undefined;
