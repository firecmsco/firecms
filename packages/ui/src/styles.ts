...
export const cardMixin = "bg-white rounded-md dark:bg-gray-950 border-gray-100 dark:border-gray-800 dark:border-opacity-80 transition duration-200 ease-in-out m-1 -p-1 border ";
