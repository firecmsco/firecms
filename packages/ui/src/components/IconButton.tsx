...
const buttonClasses = "hover:bg-surface-accent-200/75 dark:hover:bg-surface-accent-800/75 hover:scale-105 transition-transform";
const baseClasses = "inline-flex items-center justify-center p-2 text-sm font-medium focus:outline-hidden transition-colors ease-in-out duration-150";
...
const IconButtonInner = <C extends React.ElementType = "button">({
    ...
    const bgClasses = variant === "ghost" ? "bg-transparent" : "bg-surface-accent-200/50 dark:bg-surface-950/50";
