                    ...
                    return (
                        <NavLink
                            ...
                            className={({ isActive }: any) => cls("transition-opacity flex flex-col justify-between p-4",
                                ...
                                "hover:bg-surface-accent-300 hover:bg-opacity-60 hover:bg-surface-accent-300/60 dark:hover:bg-surface-700 dark:hover:bg-opacity-60 dark:hover:bg-surface-700/60 text-surface-800 dark:text-surface-200 hover:text-surface-900 hover:dark:text-white",
                                "mr-8",
                                "font-medium text-sm",
                                isActive ? "bg-surface-accent-200 bg-opacity-60 bg-surface-accent-200/60 dark:bg-surface-800 dark:bg-opacity-30 dark:bg-surface-800/30" : ""
                            )}
