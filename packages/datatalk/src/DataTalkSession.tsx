            ...
            .catch((e) => {
                ...
                const updatedMessages: ChatMessage[] = [
                    ...newMessages,
                    {
                        id: systemMessageId,
                        loading: false,
                        text: t("datatalk_error_processing_command", { error: e.message }),
                        user: "SYSTEM",
                        date: new Date()
                    }
                ];
            ...
            <div className="h-full overflow-auto"
                ...
                <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 flex-1 flex flex-col gap-4 w-full">
                    ...
                    <Tooltip
                        asChild={true}
                        delayDuration={500}
                        title={t("datatalk_auto_run_code_tooltip")}>
                        <Label
            ...
            <div className="max-w-4xl w-full sticky bottom-0 right-0 left-0 mx-auto px-4 md:px-6 pb-8 pt-4">
                <form
                    ...
                    <TextareaAutosize
                        ...
                        placeholder={t("datatalk_type_message")}
                    />
