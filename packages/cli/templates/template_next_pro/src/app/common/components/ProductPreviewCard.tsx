...
const ProductPreviewCard: React.FC<ProductPreviewCardProps> = ({ product, className }) => {
    return (
        <Link href={"/products/" + product.id}
              className={cls("relative h-72 block w-full rounded-xs overflow-hidden shadow-lg bg-white hover:shadow-xl transition duration-300 hover:scale-[1.02] text-white", className)}>
