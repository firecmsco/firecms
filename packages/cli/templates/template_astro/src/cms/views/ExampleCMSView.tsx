...
import type { Entity, EntityReference } from "@firecms/core";
import {
    Button,
    Chip,
    GitHubIcon,
...
export function ExampleCMSView() {
    ...
    const githubLink = (
        <Tooltip
            ...
            <IconButton
                href={"https://github.com/firecmsco/firecms/blob/main/examples/example_astro/src/cms/views/ExampleCMSView.tsx"}
