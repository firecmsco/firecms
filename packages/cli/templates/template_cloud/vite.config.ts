    ...
    plugins: [
        ...
        federation({
            ...
            shared: {
                ...
                "@rebasepro/cloud": { requiredVersion: "^3.0.0", generate: false },
                "@rebasepro/core": { requiredVersion: "^3.0.0", generate: false },
                "@rebasepro/firebase": { requiredVersion: "^3.0.0", generate: false },
                "@rebasepro/ui": { requiredVersion: "^3.0.0", generate: false },
