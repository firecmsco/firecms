...
export const productsCollection = buildCollection<Product>({
    ...
    properties: {
        ...
        price: ({ values }) => ({
            ...
            name: "Price",
            validation: {
                // Only while it is available: the field is disabled for an unavailable
                // product below, so an always-required price could never be satisfied and
                // such a product could not be saved at all.
            ...
            disabled: !values.available && {
                // Not cleared: an imported or existing product that is not available keeps
                // the price it has, and only stops being editable.
