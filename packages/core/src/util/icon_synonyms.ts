export const iconSynonyms = {
    ...
    add_alert: "+ active alarm announcement bell callout chime information new notifications notify plus reminder ring-3 sound symbol",
    ...
    circle_notifications: "active alarm alert bell chime notify reminder ring-3 sound",
    ...
    data_saver_off: "analytics bars chart diagram donut infographic measure metrics ring-3 statistics tracking",
    data_saver_on: "+ add analytics chart diagram infographic measure metrics new plus ring-3 statistics symbol tracking",
    ...
    edit_notifications: "active alarm alert bell chime compose create draft editing input new notify pencil reminder ring-3 sound write writing",
    ...
    filter_tilt_shift: "blur-xs center editing effect focus images photography pictures",
    ...
    notification_add: "+ active alarm alert bell chime notifications notify plus reminder ring-3 sound symbol",
    notification_important: "! active alarm alert announcement attention bell caution chime danger error exclamation feedback mark notifications notify problem reminder ring-3 sound symbol warning",
    notifications: "active alarm alert bell chime notify reminder ring-3 sound",
    notifications_active: "alarm alert bell chime notify reminder ringing sound",
    notifications_none: "alarm alert bell notify reminder ring-3 sound",
    notifications_off: "active alarm alert bell chime disabled enabled notify offline reminder ring-3 slash sound",
    notifications_paused: "--- active alarm aleet alert bell chime ignore notify pause quiet reminder ring-3 sleep snooze sound zzz",
