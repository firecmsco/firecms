...
export const coolIconKeys: string[] = ["ac_unit", "adjust", "align_horizontal_center", "album", "all_inclusive", "all_out", "animation", "assistant", "attractions", "audiotrack", "auto_awesome", "auto_awesome_mosaic", "beach_access", "bolt", "brightness1", "breakfast_dining", "broken_image", "brightness5", "cable", "calendar_view_month", "catching_pokemon", "casino", "category", "cloud", "color_lens", "credit_card", "coronavirus", "earbuds", "egg_alt", "fiber_smart_record", "flag", "healing", "heat_pump", "hive", "hub", "local_fire_department", "local_pizza", "memory", "outlet", "pages", "panorama_photosphere", "signal_cellular_0_bar", "sports_baseball", "storm", "stairs"];
