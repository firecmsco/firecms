...
export const VirtualTableHeaderRow = ({
    ...
    return (
        <div
            className="z-20 sticky min-w-full bg-background-default flex w-fit-content flex-row top-0 left-0 z-2 h-12 border-b border-gray-100 dark:border-gray-800">
