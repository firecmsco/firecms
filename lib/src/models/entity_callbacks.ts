 ...
 * @category Models
 */
export interface EntityCallbacks<M extends object = object, UserType extends User = User> {
 ...
 * @category Models
 */
export interface EntityOnFetchProps<M extends object = object, UserType extends User = User> {
 ...
 * @category Models
 */
export interface EntityOnSaveProps<M extends object = object, UserType extends User = User> {
 ...
 * @category Models
 */
export interface EntityOnDeleteProps<M extends object = object, UserType extends User = User> {
 ...
 * @category Models
 */
export interface EntityIdUpdateProps<M extends object = object, UserType extends User = User> {
