...
// Note: Run from app_userland/backend with DOTENV_CONFIG_PATH=../.env or ensure .env is in the app_userland/ folder
// The parent package.json script should set this, or you can symlink/copy the .env

if (!process.env.DATABASE_URL) {
    throw new Error("DATABASE_URL is not set. Make sure .env file exists in the app_userland/ folder and contains DATABASE_URL");
}
