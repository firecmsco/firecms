...
It generates CRUD views based on your configuration.
...
You can find the all the `CMSFieldProps` [here](https://github.com/Camberi/firecms/blob/master/src/form/form_props.tsx)
