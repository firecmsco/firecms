...
export type SchemasRegistryController = {
     ...
     * Get props for path
     */
    getCollectionConfig: (collectionPath: string, entityId?: string) => EntityCollection;
...
export const SchemaRegistryProvider: React.FC<ViewRegistryProviderProps> = ({
    ...
    const getSchema = (collectionPath: string, entityId?: string): SchemaSidePanelProps | undefined => {
        ...
        if (overriddenProps) {
            ...
            if (shouldOverrideResolver || !resolvedProps)
        ...
        if (entityCollection) {
            ...
            return { editEnabled, schema, subcollections };
        }
