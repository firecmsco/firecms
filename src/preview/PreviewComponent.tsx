...
export function PreviewComponent<T>(props: PreviewComponentProps<T>) {
    ...
    if (property.config?.customPreview) {
        ...
        content =
            <MapPreview {...fieldProps} property={property as MapProperty}/>;
        ...
        />;
    } else if (property.dataType === "boolean" && typeof value === "boolean") {
        content = <BooleanPreview {...fieldProps}
                                  value={value}
                                  property={property as BooleanProperty}/>;
    } else if (property.dataType === "number" && typeof value === "number") {
