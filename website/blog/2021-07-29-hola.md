...
admin panel/CMS solution based on Firebase!
...
thought: There must be a generic CMS based on Firebase/Firestore right?
...
Our CMS **must** allow developers to extend it in any way they need, while
keeping it extremely simple to kickstart a new project, with the bare minimum
configuration. We need **sensible defaults that can be overiden or extended**.
