...
import UnitCollection
    from "!!raw-loader!firecms-example/src/docs/recipes/document_as_subcollection/unit_collection";
import CollectionBuilder
    from "!!raw-loader!firecms-example/src/docs/recipes/document_as_subcollection/collection_builder";
import FullCode
    from "!!raw-loader!firecms-example/src/docs/recipes/document_as_subcollection/full";
