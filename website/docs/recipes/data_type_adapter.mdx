...
```typescript
import {EntityCallbacks, EntityOnFetchProps} from "firecms";
...
```typescript
import {EntityCallbacks} from "firecms";
...
```typescript
import {buildCollection, EntityCallbacks, EntityCollection, EntityOnFetchProps} from "firecms";
