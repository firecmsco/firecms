...
import MyComponentSource
    from "!!raw-loader!firecms-example/src/docs/recipes/copy_entity/simple_product_collection";
import CopyButton
    from "!!raw-loader!firecms-example/src/docs/recipes/copy_entity/copy_button";
import CopyButtonUse
    from "!!raw-loader!firecms-example/src/docs/recipes/copy_entity/copy_button_use";
import FullCode
    from "!!raw-loader!firecms-example/src/docs/recipes/copy_entity/full";
