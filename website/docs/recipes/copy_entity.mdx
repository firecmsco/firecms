...
sidebar_label: Copying an entity
---
...
import MyComponentSource from "!!raw-loader!firecms-example/src/docs/recipes/copy_entity/simple_product_collection";
...
import CopyButton from "!!raw-loader!firecms-example/src/docs/recipes/copy_entity/copy_button";

<CodeBlock language="tsx">{CopyButton}</CodeBlock>

### Add the custom copy action

After your component is ready, you can plug it into your collections `extraActions`:
```tsx
// Target collection
...
import FullCode from "!!raw-loader!firecms-example/src/docs/recipes/copy_entity/full";
