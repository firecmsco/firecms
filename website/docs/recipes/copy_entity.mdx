...
description: How to implement custom logic to copy an entity from one collection to another
---
...
instance. If you don't, check the [Quickstart](customization_quickstart.mdx) section.
:::
