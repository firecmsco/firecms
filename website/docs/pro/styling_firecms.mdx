...
These are the default values but you can change them to match your brand. The `--fcms-primary-bg`
variable is used when hovering over primary elements, like some buttons or cards. The `--fcms-primary-bg`
variable is used for the darker version of the primary color.
