...
FireCMS PRO is the self-hosted version of FireCMS that includes all the most advanced features such as the collection editor,
data import and export, user and roles management, or the openAI integration.
