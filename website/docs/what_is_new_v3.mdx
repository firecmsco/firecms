...
The components are fully typed and documented. You can find the documentation [here](/docs/components/intro).
...
We have also added an [icon search function](/docs/icons/icons) in the website to find the icon you need.
