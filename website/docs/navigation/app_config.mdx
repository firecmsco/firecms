...
* `collectionOverrideHandler`Used to override collections based on the collection path and entityId.
...
* `baseCollectionPath` Default path under the navigation routes of the CMS will be created
