...
```
yarn add @camberi/firecms@next firebase@^9 @mui/material@^5 @mui/icons-material@^5 @mui/lab@^5 @mui/styles@^5 @mui/x-date-pickers@^5.0.0-beta.1 @emotion/react @emotion/styled react-router@^6 react-router-dom@^6
```
...
import MyComponentSource from "!!raw-loader!../../example/src/SimpleApp";
