...
There are no docs for migrating to FireCMS PRO. In that case we recommend
initializing a new project and migrating your collections and views.
Still, some of the information in this guide might be useful.
:::
