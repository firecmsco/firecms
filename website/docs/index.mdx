...
- You also have self-hosted options in the [**PRO**](/docs/pro) plan. In this version you need to deploy FireCMS to
...
the schema of your collections. Check the [**dynamic collections**](./collections/dynamic_collections.md) section
