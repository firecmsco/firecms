...
:::important FireCMS is an **open source headless CMS and admin panel**. It is a platfowm where you can build full companies, or your weekend side project.
:::
...
your content in a user-friendly interface, and use it as a no-code tool, or extend its functionality with code.
- You also have self-hosted options in the [PRO](./docs/pro) plan. In this version you need to deploy FireCMS to your server,
and you have full control over the code, with many customization options.
