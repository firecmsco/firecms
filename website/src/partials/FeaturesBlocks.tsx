                ...
                <div className="py-12 md:py-20">
                    ...
                    <div
                        ...
                        <div
                            data-aos="fade-up"
                            data-aos-delay="100"
                            className="relative flex flex-col items-center p-6 bg-white rounded shadow-lg">
                            <svg
                            ...
                            <h4 className="text-black text-xl font-bold leading-snug tracking-tight mb-1">
                                Schema validation
                            </h4>
