...
export const CTAOutlinedButtonMixin = "btn px-10 py-4 md:px-12 border-1 border-slate-600 dark:border-slate-700  uppercase rounded border-solid dark:text-white text-slate-800 hover:text-slate-700 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-900 h dark:hover:border-slate-800 text-center";
export const CTAOutlinedButtonWhiteMixin = "btn px-10 py-4 md:px-12  border-1 border-white  uppercase rounded border-solid text-white hover:bg-slate-200 hover:border-slate-200 text-center";
