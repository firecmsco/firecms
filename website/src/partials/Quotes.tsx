                    ...
                    quotes.map(({ quote,avatar, author, role }, i) => (
                        <>
                            <blockquote key={`quote-${i}`}
                                        className={clsx("pt-16 w-96 min-w-[380px] bg-gray-50 dark:bg-gray-700 relative flex flex-col items-center justify-center px-8 py-6 rounded-2xl border", defaultBorderMixin)}>
                                <svg xmlns="http://www.w3.org/2000/svg" className={"text-inherit"} width="24"
                                     height="24" viewBox="0 0 24 24">
                                    <path
                                        d="M9.983 3v7.391c0 5.704-3.731 9.57-8.983 10.609l-.995-2.151c2.432-.917 3.995-3.638 3.995-5.849h-4v-10h9.983zm14.017 0v7.391c0 5.704-3.748 9.571-9 10.609l-.996-2.151c2.433-.917 3.996-3.638 3.996-5.849h-3.983v-10h9.983z"/>
                                </svg>
                                <p className="italic mb-4 text-2xl mt-4 font-bold leading-snug tracking-tight text-center">{quote}</p>
                                <img loading="lazy"
