...
export function ManageYour() {
    return <section
        ...
        <div
            className={ContainerMixin + " h1 relative items-center text-white uppercase "}>
        ...
        <div className={ContainerMixin + " mt-4 text-xl"}>
            <p>
        ...
        <div className={ContainerMixin + " mt-4 mx-auto"}>
            <a
