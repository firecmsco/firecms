...
export const CTAButtonMixin = "btn py-4 px-8 text-white bg-primary hover:bg-blue-700  hover:text-white uppercase border-solid rounded text-center";
...
export const defaultBorderMixin = "border-solid border-surface-500 border-opacity-30 dark:border-surface-500 dark:border-opacity-30";
