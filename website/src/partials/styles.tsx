...
export const CTAOutlinedButtonMixin = "btn px-10 py-4 md:px-12 border-1 border-gray-600 dark:border-gray-700 uppercase rounded border-solid text-inherit dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-900 h dark:hover:border-gray-800 text-center";
...
export const defaultBorderMixin = "border-solid border-gray-800 border-opacity-60 dark:border-gray-950 dark:border-opacity-80";
