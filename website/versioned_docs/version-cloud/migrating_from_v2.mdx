...
The new version provides a backend service that allows you to manage your
...
The package has been renamed to `@firecms/firebase` and the main entry point is now
...
Simply export your collections in your `index.ts` file:
...
Some features are no longer supported in FireCMS 3.0. Some of them will be added in future releases.
...
FireCMS 3.0 is based on tailwindcss instead of material-ui.
